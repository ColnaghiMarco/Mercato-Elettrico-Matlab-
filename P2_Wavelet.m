...
wavelet_data = y_PUN; % Estrai i dati della colonna corrente

% Decomposizione con wavelet
[C, L] = wavedec(wavelet_data, level, wname);
...
residues = wavelet_data - smoothed_data;
...
for i=1:n_predictions
    ...
    % Decomposizione con wavelet
    [C, L] = wavedec(Y_dati_storici, level, wname);
    ...
    % Ricostruzione del segnale denoised
    smoothed_forecast = waverec(C_denoised, L, wname);
